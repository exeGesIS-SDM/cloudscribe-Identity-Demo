...
function embedPowerBIReport() {
    ...
    let accessToken = $("#embedContainer").data("pbiembedaccesstoken");
    console.log(accessToken);

    // Read embed URL
    //let embedUrl = EMBED_URL;
    let embedUrl = $("#embedContainer").data("pbiembedurl");
    console.log(embedUrl);

    // Read report Id
    //let embedReportId = REPORT_ID;
    let embedReportId = $("#embedContainer").data("pbiembedreportid");
    console.log(embedReportId);

    // Read embed type from radio
    let tokenType = models.TokenType.Embed;
    //let tokenType = $("#embedContainer").data("pbitokentype");
